...
import { ArrowLeft, Smartphone, QrCode, Copy, Check, Clock, AlertCircle } from 'lucide-react';
  ...
  const handleOpenUpiApp = useCallback(() => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "If your UPI app opened, complete the payment there. Then click 'I've Paid' below.",
        duration: 5000,
      });
    }, 1000);
  }, [upiUrl]);
